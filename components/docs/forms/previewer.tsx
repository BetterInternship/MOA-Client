...
export const DocumentRenderer = ({
  ...
  onHighlightFinished?: (highlight: DocumentHighlight, transform: DocumentObjectTransform) => void;
}) => {
  ...
  const createPreviews = (paginatedPreviews: Record<number, React.ReactNode[]>) => {
    const previews = [];
