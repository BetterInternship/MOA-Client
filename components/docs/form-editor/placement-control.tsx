 ...
 * @ Modified time: 2025-12-17 00:00:54
...
const PlacementModeActive = ({
  ...
  <div className="border-primary bg-primary/5 flex items-center gap-3 rounded-md border px-4 py-3">
    <div className="flex-1">
      ...
      <p className="text-muted-foreground text-xs">Click on the PDF to place a {fieldType} field</p>
    </div>
...
export const PlacementControl = ({
  ...
  if (isPlacing) {
    return <PlacementModeActive fieldType={fieldType} onCancelPlacing={onCancelPlacing} />;
  }

  return (
    <div className="space-y-2">
      <FieldTypeSelect value={fieldType} onChange={onFieldTypeChange} />
